...
function App() {
  return (
    <Grommet theme={theme}>
      <Box align="center" background="black" size="large">
    ...
    <Image src="./at_at_street.png" 
          ...
          <Paragraph align="center" size="xxlarge">
            abbas tolgay yılmaz
          </Paragraph>
      ...
      <Box>.</Box> */}
          ...
          <Paragraph>building a decentralized future,</Paragraph>

          <Paragraph color="white">
            at{" "}
            <Anchor href="https://stateful.art" target="_blank" color="red">
              stateful.art
            </Anchor>
          </Paragraph>
        ...
        <Box>.</Box>
        <Paragraph>
          the revolution <br></br> will be minted.
        </Paragraph>
        <Box>.</Box>
        <Box>.</Box>
        <Box>.</Box>
